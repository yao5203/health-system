...
export const api = {
  ...
  getDoctorOverview(doctorId) {
    return request(`/doctor/overview/${encodeURIComponent(doctorId)}`)
  },
  ...
  getDoctorConsultationSnapshot(consultationId, doctorId) {
    return request(`/doctor/consultations/${encodeURIComponent(consultationId)}/snapshot?doctorId=${encodeURIComponent(doctorId)}`)
  },
